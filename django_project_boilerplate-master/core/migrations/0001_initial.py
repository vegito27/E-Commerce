# Generated by Django 2.2.8 on 2020-09-01 03:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('d', 'danger'), ('s', 'secondary'), ('p', 'primary')], max_length=2)),
                ('description', models.TextField()),
                ('category', models.CharField(choices=[('S', 'Shirt'), ('O', 'OutWear'), ('SW', 'SportsWear')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered', models.BooleanField(default=False)),
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Item2')),
